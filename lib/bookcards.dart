          ...
          Expanded(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                  //print("Check1");
                  List<DocumentSnapshot> pre_documents = snapshot.data!.docs;
                  List<DocumentSnapshot> documents = [];
                  for (DocumentSnapshot document in pre_documents) {
                      ...
                      itemBuilder: (context, int index) {
                        ...
                        return Slidable(
                          ...
                          endActionPane: ActionPane(
                            ...
                            // dismissible: DismissiblePane(onDismissed: () {//条件を満たすとき跳ね返すってできればいいのだけれど。
                            //   if (widget.bookInfo['isPublic'] == true) {
                            //     ScaffoldMessenger.of(context).showSnackBar(
                            //         const SnackBar(
                            //             content: Text('Publicのためアーカイブできません')));
                            //   } else {
                            //     setState(() {
                            //       //ここ逆だと、一瞬removeAtで消えたやつの次のやつが間違って消される。
                            //       //documentsで消しても大元が消えてないから
