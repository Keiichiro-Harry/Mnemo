...
class RecomCards extends StatefulWidget {
  RecomCards(this.user, this.bookInfo);
  // ユーザー情報
  final User user;
  final DocumentSnapshot<Object?> bookInfo;
  @override
  State<RecomCards> createState() => _RecomCardsState();
}

class _RecomCardsState extends State<RecomCards> {
  String _accountName = '';
                        ...
                        return Slidable(
                          ...
                          child: Card(
                              child: ListTile(
                                  ...
                                  subtitle: Text(documents[index]['comment']+" number:"+(documents[index]['number']).toString()),
